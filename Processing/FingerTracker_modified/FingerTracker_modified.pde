...
void draw() {
  ...
  PVector topFingerPos = topFingerPosition(fingers);
  print("x: " + topFingerPos.x + ", ");
  println("y: " + topFingerPos.y);
...
PVector topFingerPosition(FingerTracker fingers) {
